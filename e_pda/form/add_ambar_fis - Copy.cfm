...
<script language="JavaScript">
	...
	function checkKeycode(e) 
	{
		...
		if (keycode == 13)
		{
			if (document.getElementById('add_other_barcod').value.length == 13 && document.getElementById('add_other_shelf').value.length == '')
			{
			...
			else if (document.getElementById('add_other_barcod').value.length == 13 && (document.getElementById('add_other_shelf').value.length == 8 || document.getElementById('add_other_shelf').value.length == 11))
			{
				search_shelf(document.getElementById('add_other_shelf').value);
			}
			else
			{
				alert('Ürün Borkodu Hatalı');
				document.getElementById('add_other_barcod').value = '';
				document.getElementById('add_other_shelf').value = '';
				document.getElementById('add_other_amount').value = 1;
				document.getElementById('add_other_barcod').focus();	
