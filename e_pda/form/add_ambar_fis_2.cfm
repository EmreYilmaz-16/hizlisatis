<cf_box title="Depodan Mal Kabule">
...
<cfform name="form_basket">
  ...
  <cfinput type="hidden" name="active_period" value="#session.ep.period_id#" />
  <div style="width:100%">
  ...
  <a href="<cfoutput>#request.self#?fuseaction=epda.prtotm_svk_kontrol</cfoutput>"><img style="width:30px;height:30px" src="../../images/e-pd/tickmav30.png" title="Sevkiyat Kontrol"></a>&nbsp;&nbsp;
    ...
    <tr >
      <td colspan="4">
          ...
          <tr height="20px" >
            <td><div class="form-group"><input id="add_other_amount" name="add_other_amount" type="text" class="moneybox" onfocus="islemtipi=0;" style="width:90%; text-align:right" value="1" /></div></td>
            <td><div class="form-group"><input id="add_other_barcod" name="add_other_barcod" type="text" value="" style="width:90%;" ></div></td>
            <td><div class="form-group"><input id="add_other_shelf" name="add_other_shelf" type="text" class="moneybox" onfocus="islemtipi=0;" style="width:90%;" value="" /></div></td>
            <td>
              <table>
              	<tr>
...
<table style="width:100%">
    <tr  height="15px">
      <td  align="center">Barkod</td>
      <td  align="left">Ürün Adı</td>
      <td  align="right">Mikt.</td>
...
<script language="javascript" type="text/javascript">
		function kontrol_kayit()
		{
			...
			{
			actionidolustur();
			window.location.href='<cfoutput>#request.self#</cfoutput>?fuseaction=epda.prtotm_Qadd_ambar_fis&tersfis=1&dep_in='+form_basket.txt_department_in.value+'&dep_out='+form_basket.txt_department_out.value+'&action_id='+document.getElementById('action_id').value+'&fis_tipi='+form_basket.fis_tipi.value+'&process_cat='+form_basket.process_cat_id.value+'&active_period='+form_basket.active_period.value;
			}
		}
