  ...
  <table cellpadding="2" cellspacing="1" align="left" class="color-border" width="99%">
    <tr class="color-list">
      <td colspan="4">
          ...
          <tr class="color-list">
            <td align="center" width="40px">Miktar</td>
            <td align="center" width="80px">Barcode</td>
            <td align="center" width="70px">Çıkış Raf</td>
            <td align="center" width="70px">Giriş Raf</td>
       	  </tr>
          <tr class="color-list">
