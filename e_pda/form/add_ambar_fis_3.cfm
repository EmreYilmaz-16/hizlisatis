  ...
  <a href="<cfoutput>#request.self#?fuseaction=epda.prtotm_svk_kontrol</cfoutput>"><img style="width:30px;height:30px" src="../../images/e-pd/tickmav30.png" title="Sevkiyat Kontrol"></a>&nbsp;&nbsp;
    ...
    <tr class="color-list">
      <td colspan="4">
          ...
          <tr class="color-list">
            <td align="center" width="20px">Miktar</td>
            <td align="center" width="90px">Barcode</td>
            <td align="center" width="75px">Çıkış Raf</td>
            <td align="center" width="75px">Giriş Raf</td>
       	  </tr>
          <tr class="color-list">
            <td><input id="add_other_amount" name="add_other_amount" type="text" class="moneybox" onfocus="islemtipi=0;" style="width:100%; text-align:right" value="1" /></td>
            <td><input id="add_other_barcod" name="add_other_barcod" type="text" value="" style="width:100%	;" ></td>
            <td><input id="add_out_shelf" name="add_out_shelf" type="text" class="moneybox" onfocus="islemtipi=0;" style="width:100%;" value="" /></td>
            <td><input id="add_in_shelf" name="add_in_shelf" type="text" class="moneybox" onfocus="islemtipi=0;" style="width:100%;" value="" /></td>
          </tr>
          <tr class="color-list">
          	<td colspan="4">
              <table>
              	<tr>
                    ...
                    <td id="shelf_select_td" style="display:none">
                        <select name="shelf_select" id="shelf_select" style="width:100%; text-align:center">
    ...
    <tr class="color-list">
      <td colspan="4">
      	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="color-border">
           ...
           <tr class="color-list">
            <td>
              <select name="txt_department_out" style="width:100%" onchange="document.getElementById('department_out').value = this.value">
            ...
            <td>
              <select name="txt_department_in" style="width:100%" onchange="document.getElementById('department_in').value = this.value">
                <cfoutput query="get_all_location" group="department_id">
...
<script language="javascript" type="text/javascript">
		function kontrol_kayit()
		{
			...
			{
			actionidolustur();
			window.location.href='<cfoutput>#request.self#</cfoutput>?fuseaction=epda.prtotm_qadd_ambar_fis&change_shelf_fis=1&dep_in='+form_basket.txt_department_in.value+'&dep_out='+form_basket.txt_department_out.value+'&action_id='+document.getElementById('action_id').value+'&fis_tipi='+form_basket.fis_tipi.value+'&process_cat='+form_basket.process_cat_id.value;
			}
		}
