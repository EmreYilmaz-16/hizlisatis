 ...
 <cfset PRTOTM_department_id = 6> <!---Firmaya Göre Değişir---> <!---Bursa Depo--->
...
<script language="javascript">
	...
	function pn_kontrol()
	{
		geciktir1 = setTimeout("window.location.href='<cfoutput>#request.self#?fuseaction=sales.list_PRTOTM_shipping_portal</cfoutput>'", 100000);
	}
	...
	function degisim(is_type,action_id)
	{
		...
		window.open('<cfoutput>#request.self#</cfoutput>?fuseaction=sales.emptypopup_upd_PRTOTM_sevk_emp&sevk_emp_id='+sevk_emp_id+'&is_type='+is_type+'&action_id='+action_id);
	}
	function goster()
	{
