...
<cfparam name="attributes.report_type_id" default="">
...
<cfquery name="GET_PRODUCT_CATS" datasource="#dsn1#">
	...
	WHERE     
        ...
        (PC.HIERARCHY LIKE '#cat_criter1#%' OR
        PC.HIERARCHY LIKE '#cat_criter2#%')
 	ORDER BY
    	PRODUCT_CAT
</cfquery>
        ...
        <cf_object_main_table>
            ...
            <cf_object_table column_width_list="50,75">
                ...
                <cf_object_tr id="zone_id" title="#header_#">
                    <cf_object_td>
                        <select name="report_type_id" id="report_type_id" style="width:120px;">
							<option value="" <cfif attributes.report_type_id eq ''>selected</cfif>>Tümü</option>
                            <option value="1" <cfif attributes.report_type_id eq '1'>selected</cfif>>Kapanmış Sevkler</option>
							<option value="2" <cfif attributes.report_type_id eq '2'>selected</cfif>>Açık Sevkler</option>
                            <option value="4" <cfif attributes.report_type_id eq '4'>selected</cfif>>Tamamı Hazır Sevkler</option>
                            <option value="5" <cfif attributes.report_type_id eq '5'>selected</cfif>>2.Kez Gidelecek</option>
                            <option value="6" <cfif attributes.report_type_id eq '6'>selected</cfif>>Kısmi Kapanmış Sevkler</option>
					</select>                    
                    </cf_object_td>
                </cf_object_tr>
            </cf_object_table>
            <cf_object_table column_width_list="50,75">
                ...
                <cf_object_tr id="zone_id" title="#header_#">
                    <cf_object_td>
                        <select name="zone_id" id="zone_id" style="width:160px;">
                ...
                <cf_object_tr id="form_ul_sort_type" title="#header_#">
                    <cf_object_td>
                        <select name="sort_type" id="sort_type">
                            <option value="1" <cfif attributes.sort_type eq 1>selected</cfif>><cf_get_lang no='41.Teslim Tarihine Gre Artan'></option>
                            <option value="2" <cfif attributes.sort_type eq 2>selected</cfif>><cf_get_lang no='42.Teslim Tarihine Gre Azalan'></option>
            ...
            <cf_object_table column_width_list="75">
                ...
                <cf_object_tr id="form_ul_sort_type" title="#header_#">
                    <cf_object_td>
                        <select name="listing_type" id="sort_type">
            ...
            <cf_object_table column_width_list="100">
                ...
                <cf_object_tr id="form_ul_start_date" title="#header_#">
                    <cf_object_td>
                        ...
                        <cfelse>
                            <cfsavecontent variable="message"><cf_get_lang no='276.Baslangi Tarihi Kontrol Ediniz'></cfsavecontent>
            ...
            <cf_object_table column_width_list="200">
                <cf_object_tr id="">
                    <cf_object_td>
                        <cfsavecontent variable="message"><cf_get_lang_main no='125.Sayi_Hatasi_Mesaj'></cfsavecontent>
                        <cfinput type="text" name="maxrows" value="#attributes.maxrows#" required="yes" onKeyUp="isNumber(this)" validate="integer" range="1,999" message="#message#" maxlength="3" style="width:25px;">
                        <a href="javascript://" onclick="windowopen('<cfoutput>#request.self#?fuseaction=sales.popup_list_PRTOTM_packing</cfoutput>','longpage');" class="tableyazi">
                        	<img src="../../../images/kasa.gif" align="absmiddle" border="0" title="Paketleme" />
                      	</a>
                        <a href="javascript://" onclick="windowopen('<cfoutput>#request.self#?fuseaction=sales.popup_list_PRTOTM_shipping_graph</cfoutput>','longpage');" class="tableyazi">
                        	<img src="../../../images/graph.gif" align="absmiddle" border="0" title="Sevkiyat Perspektif" />
                      	</a>
                        <a href="javascript://" onclick="windowopen('<cfoutput>#request.self#?fuseaction=sales.popup_list_PRTOTM_shipping_deliver</cfoutput>','longpage');" class="tableyazi">
                        	<img src="../../../images/target_customer.gif" align="absmiddle" border="0" title="Sevk Planı Açılacak Siparişler" />
                      	</a>
                        <a href="javascript://" onclick="windowopen('<cfoutput>#request.self#?fuseaction=sales.popup_list_PRTOTM_shipping_control</cfoutput>','wide');" class="tableyazi">
                        	<img src="../../../images/pos_credit.gif" align="absmiddle" border="0" title="Sevkiyat Talebi Kontrol" />
                      	</a>
    ...
    <cf_big_list_search_detail_area>
        <cf_object_main_table>
            <cf_object_table column_width_list="90,140">
                <cfsavecontent variable="header_"><cf_get_lang no='101.Satis Yapan'></cfsavecontent>
                <cf_object_tr id="form_ul_order_employee" title="#header_#">
                    <cf_object_td type="text" td_style="text-align:right;"><cf_get_lang no='101.Satis Yapan'></cf_object_td>
                    <cf_object_td>
            ...
            <cf_object_table column_width_list="90,140">
                ...
                <cf_object_tr id="form_ul_member_name" title="#header_#">
                    ...
                    <cf_object_td>
                        ...
                        <input name="member_name" type="text" id="member_name" style="width:125px;" onfocus="AutoComplete_Create('member_name','MEMBER_NAME,MEMBER_PARTNER_NAME,MEMBER_CODE','MEMBER_NAME,MEMBER_PARTNER_NAME,MEMBER_CODE','get_member_autocomplete','\'1,2\'','CONSUMER_ID,COMPANY_ID,MEMBER_TYPE','consumer_id,company_id,member_type','','3','250');" value="<cfif isdefined("attributes.member_name") and len(attributes.member_name)><cfoutput>#attributes.member_name#</cfoutput></cfif>" autocomplete="off">
            ...
            <cf_object_table column_width_list="50,125">
            ...
            <cf_object_table column_width_list="50,100">
                ...
                <cf_object_tr id="form_ul_prod_cat" title="#header_#">
                    <cf_object_td>
                        <select name="prod_cat" id="prod_cat" style="width:150px;">
             ...
             <cf_object_table column_width_list="75">
              	<cfsavecontent variable="header_">Şube</cfsavecontent>
               	<cf_object_tr id="form_ul_branch_id" title="#header_#">
                 	<cf_object_td>
                    	<select name="branch_id" id="branch_id" style="width:130px;">
            ...
            <cf_object_table column_width_list="50,75">
                <cfsavecontent variable="header_"><cf_get_lang no ='382.Depo- Lokasyon'></cfsavecontent>
                <cf_object_tr id="form_ul_sales_departments" title="#header_#">
                    <cf_object_td>
                        <select name="sales_departments" id="sales_departments" style="width:100px;">
                            <option value=""><cf_get_lang no ='382.Depo- Lokasyon'></option>
        	...
        	<cfif isdefined("attributes.form_varmi") and GET_SHIPPING.recordcount>
					...
					<cfoutput query="GET_SHIPPING" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
                    	<tr>
                            ...
                            <td style="text-align:center">
                                <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=sales.popup_upd_PRTOTM_shipping&iid=#SHIP_RESULT_ID#','page');" class="tableyazi" title="Sevk Fişine Git">
	                                #DELIVER_PAPER_NO#
                                </a>
							</td>
                ...
                <cfelse>
					<cfoutput query="GET_SHIPPING" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
                               			...
                               			FROM            
                                        	(
                                            	SELECT        
                                                    ...
                                                    WRK_ROW_RELATION_ID
                                           		FROM            
                                                	#dsn#_#session.ep.period_year#_#session.ep.company_id#.dbo.INVOICE_ROW
                                            	UNION ALL
                                             	SELECT        
                                                	IR.AMOUNT, 
                                                    IR.WRK_ROW_RELATION_ID
                                             	FROM            
                                                	#dsn#_#session.ep.period_year#_#session.ep.company_id#.dbo.SHIP_ROW AS SR INNER JOIN
                                                 	#dsn#_#session.ep.period_year#_#session.ep.company_id#.dbo.INVOICE_ROW AS IR ON SR.WRK_ROW_ID = IR.WRK_ROW_RELATION_ID
                                              	<cfif get_period_id.recordcount>
                                                    ...
                                                    SELECT        
                                                        ...
                                                        WRK_ROW_RELATION_ID
                                                    FROM            
                                                        #dsn#_#last_year#_#session.ep.company_id#.dbo.INVOICE_ROW
                                                    UNION ALL
                                                    SELECT        
                                                        IR.AMOUNT, 
                                                        IR.WRK_ROW_RELATION_ID
                                                    FROM            
                                                        #dsn#_#last_year#_#session.ep.company_id#.dbo.SHIP_ROW AS SR INNER JOIN
                                                        #dsn#_#last_year#_#session.ep.company_id#.dbo.INVOICE_ROW AS IR ON SR.WRK_ROW_ID = IR.WRK_ROW_RELATION_ID
                                                </cfif>
                                          	) AS TBLA
                               			GROUP BY 
                                         	WRK_ROW_RELATION_ID
                        ...
                        <cfif not len(attributes.report_type_id) or get_sevk_durum.sevk_durum eq attributes.report_type_id>
                            <tr>
                                <td>#currentrow#</td>
                                <td style="text-align:center">
                                    <cfif IS_TYPE eq 1>
                                ...
                                <td style="text-align:center"> <!---Sevk Indicator--->
                                    <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=sales.popup_upd_PRTOTM_shipping_sevk&iid=#SHIP_RESULT_ID#&is_type=#is_type#','page');" class="tableyazi" title="Sevk Emri Ver">
                                            ...
                                            SELECT     
                                                ...
                                                SELECT 
                                               	...
                                               	FROM
                                                    ...
                                                    FROM            
                                                        #dsn#_#session.ep.period_year#_#session.ep.company_id#.dbo.STOCK_FIS AS SF INNER JOIN
                                                        #dsn#_#session.ep.period_year#_#session.ep.company_id#.dbo.STOCK_FIS_ROW AS SFR ON SF.FIS_ID = SFR.FIS_ID
                                                    WHERE        
                                                        SF.FIS_TYPE = 113 AND 
                                                    ...
                                                    <cfif get_period_id.recordcount>
                                                        ...
                                                        SELECT        
                                                            SUM(SFR.AMOUNT) AS CONTROL_AMOUNT
                                                        FROM            
                                                            #dsn#_#last_year#_#session.ep.company_id#.dbo.STOCK_FIS AS SF INNER JOIN
                                                            #dsn#_#last_year#_#session.ep.company_id#.dbo.STOCK_FIS_ROW AS SFR ON SF.FIS_ID = SFR.FIS_ID
                                                        WHERE        
                                                            SF.FIS_TYPE = 113 AND 
                                                            SF.REF_NO = '#DELIVER_PAPER_NO#' AND 
                                                            SFR.STOCK_ID = TBL.PAKET_ID
                                ...
                                <td style="text-align:center"> <!---Hazırlama Indicator--->
                                	<cfif AMBAR_CONTROL.recordcount AND AMBAR_CONTROL.PAKET_SAYISI eq 0 and AMBAR_CONTROL.CONTROL_AMOUNT eq 0>
                                    	<a href="javascript://" onclick="windowopen('#request.self#?fuseaction=sales.popup_upd_PRTOTM_shipping_ambar_control&ref_no=#DELIVER_PAPER_NO#&ship_id=#SHIP_RESULT_ID#&is_type=#is_type#','page');" class="tableyazi" title="Detay Göster"><img src="/images/plus_ques.gif" border="0" title="Barkod Yok.">
                                        </a>
                                     <cfelseif AMBAR_CONTROL.recordcount AND ceiling(AMBAR_CONTROL.PAKET_SAYISI) - ceiling(AMBAR_CONTROL.CONTROL_AMOUNT) eq 0>
                                     	<a href="javascript://" onclick="windowopen('#request.self#?fuseaction=sales.popup_upd_PRTOTM_shipping_ambar_control&ref_no=#DELIVER_PAPER_NO#&ship_id=#SHIP_RESULT_ID#&is_type=#is_type#','page');" class="tableyazi" title="Detay Göster"><img src="/images/red_glob.gif" border="0" title="Sevk Edildi.">
                                        </a>
                                     <cfelseif AMBAR_CONTROL.recordcount AND AMBAR_CONTROL.CONTROL_AMOUNT eq 0>
                                     	<cfif IS_SEVK_EMIR eq 1>
                                        	<a href="javascript://" onclick="windowopen('#request.self#?fuseaction=sales.popup_upd_PRTOTM_shipping_ambar_control&ref_no=#DELIVER_PAPER_NO#&ship_id=#SHIP_RESULT_ID#&is_type=#is_type#','page');" class="tableyazi" title="Detay Göster"><img src="/images/blue_glob.gif" border="0" title="Sevk Emri Verildi.">
                                            </a>
                                        <cfelse>
                                            <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=sales.popup_upd_PRTOTM_shipping_ambar_control&ref_no=#DELIVER_PAPER_NO#&ship_id=#SHIP_RESULT_ID#&is_type=#is_type#','page');" class="tableyazi" title="Detay Göster"><img src="/images/yellow_glob.gif" border="0" title="Sevk Edilmedi.">
                                            </a>
                                        </cfif>
                                     <cfelseif AMBAR_CONTROL.recordcount AND AMBAR_CONTROL.PAKET_SAYISI gt AMBAR_CONTROL.CONTROL_AMOUNT>
                                     	<a href="javascript://" onclick="windowopen('#request.self#?fuseaction=sales.popup_upd_PRTOTM_shipping_ambar_control&ref_no=#DELIVER_PAPER_NO#&ship_id=#SHIP_RESULT_ID#&is_type=#is_type#','page');" class="tableyazi" title="Detay Göster"><img src="/images/green_glob.gif" border="0" title="Eksik Sevkiyat.">
                                        </a>
                                     <cfelseif AMBAR_CONTROL.recordcount AND ceiling(AMBAR_CONTROL.PAKET_SAYISI) lt ceiling(AMBAR_CONTROL.CONTROL_AMOUNT)>
                                     	<a href="javascript://" onclick="windowopen('#request.self#?fuseaction=sales.popup_upd_PRTOTM_shipping_ambar_control&ref_no=#DELIVER_PAPER_NO#&ship_id=#SHIP_RESULT_ID#&is_type=#is_type#','page');" class="tableyazi" title="Detay Göster"><img src="/images/black_glob.gif" border="0" title="Fazla Sevkiyat">  
                                        </a>
                                     </cfif>
                                </td>
                                <cfif IS_TYPE eq 1>    
                                ...
                                <td style="text-align:center"> <!---El Terminali 1 Kontrol Indicator--->
                                    <cfif PACKEGE_CONTROL.recordcount AND PACKEGE_CONTROL.PAKET_SAYISI eq 0 and PACKEGE_CONTROL.CONTROL_AMOUNT eq 0>
                                        <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=sales.popup_upd_PRTOTM_shipping_term_control&ship_id=#SHIP_RESULT_ID#&is_type=#is_type#','page');" class="tableyazi" title="Detay Göster">
                                ...
                                <!---<td style="text-align:center"> <!---El Terminali 2 Kontrol Indicator--->
                                    <cfif PACKEGE_CONTROL.recordcount AND PACKEGE_CONTROL.PAKET_SAYISI eq 0 and PACKEGE_CONTROL.CONTROL_AMOUNT2 eq 0>
                                        <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=sales.popup_upd_PRTOTM_shipping_term_control_repeat&ship_id=#SHIP_RESULT_ID#&is_type=#is_type#','page');" class="tableyazi" title="Detay Göster">
                                            <img src="/images/plus_ques.gif" border="0" title="Barkod Yok." />
                                        </a>
                                ...
                                <td style="text-align:center">
                                    ...
                                    <cfelse>
                                    	<cfif DURUM eq 1>
                                        	<cfif ceiling(AMBAR_CONTROL.recordcount) AND ceiling(AMBAR_CONTROL.PAKET_SAYISI) - ceiling(AMBAR_CONTROL.CONTROL_AMOUNT) eq 0 and ceiling(PACKEGE_CONTROL.recordcount) AND ceiling(PACKEGE_CONTROL.PAKET_SAYISI) - ceiling(PACKEGE_CONTROL.CONTROL_AMOUNT) eq 0>
                                                <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=invoice.add_sale_invoice_from_order&order_id=#order_id#&order_row_id=#order_row_id_list#','longpage');" class="tableyazi" title="Toptan Satış Faturası Oluştur">
						...
						<cfif attributes.totalrecords gt son_row>
                            <cfoutput>
                                ...
                                <td style="text-align:right;" colspan="4">
                                	<!---<input type="button" value="Birleştir" onClick="grupla(-3);">--->
		...
		{//type sadece -1 olarak gelir,-1 geliyorsa hepsini seç demektir.
			...
			if(shipping_id_list!='')
			{
				if(type == -3)
				{
					...
					if(soru==true)
					{
						window.open('<cfoutput>#request.self#</cfoutput>?fuseaction=sales.upd_PRTOTM_shipping_row&shipping_id_list='+shipping_id_list);
					}
				}
				else if(type == -2)
				{
