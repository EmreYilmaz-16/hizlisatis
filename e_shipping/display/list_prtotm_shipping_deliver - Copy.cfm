    ...
    <cfquery name="GET_SHIPPING" datasource="#dsn3#">
		...
		FROM         
            ...
            SELECT   
                ...
                ORR.DELIVER_AMOUNT
       		FROM          
            	PRTOTM_SHIP_RESULT_ROW AS ESRR RIGHT OUTER JOIN
			...
			FROM         
                ...
                PRTOTM_ORDER_TESHIR AS EOT ON ORR.ORDER_ROW_ID = EOT.ORDER_ROW_ID LEFT OUTER JOIN
                (
                SELECT     
                	ROW_ORDER_ID
               	FROM          
			...
			WHERE     
            	O.ORDER_STATUS = 1 AND 
                O.IS_INSTALMENT IS NOT NULL AND 
                O.RESERVED = 1 AND 
                (
                ORR.ORDER_ROW_CURRENCY = - 1 OR
               	ORR.ORDER_ROW_CURRENCY = - 2 OR
	...
	<table class="big_list">
		<thead>
			<tr>
				...
				<th style="text-align:center"; width="60px">Sipariş No</th>
				<th style="text-align:center"; width="80px">Sipariş Tarihi</th>
				<th style="text-align:center"; width="80px">Termin Tarihi</th>
				<th style="text-align:center"; width="180px">Müşteri</th>
				<th style="text-align:center";>Ürün</th>
				<th style="text-align:center"; width="80px">Miktar</th>   
				...
				<th style="text-align:center"; width="80px">Rezerve</th> 
				<th style="text-align:center"; width="80px">Teslim Miktar</th>
			</tr>
		</thead>
		<tbody>
        	<cfif GET_SHIPPING.recordcount>
            	<cfoutput query="GET_SHIPPING" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
                	<tr>
                        ...
                        <td style="text-align:center">
                        	<cfif RESERVE_TYPE eq -1>Rezerve
                            <cfelseif RESERVE_TYPE eq -2>Kısmi Rezerve
                            <cfelseif RESERVE_TYPE eq -3><font color="red"><strong>Rezerve Değil</strong></font>
                            <cfelseif RESERVE_TYPE eq -4><font color="red"><strong>Rezerve Kapatıldı</strong></font>
                            </cfif>
                        </td>
                ...
                <cfif son lt attributes.totalrecords>
                    ...
                    <tfoot>
                        <tr>
                            <td style="text-align:left" colspan="7"><strong>Sayfa Toplamı</strong></td>
                ...
                <cfelse>
                	...
                	<tfoot>
                        <tr>
                            <td style="text-align:left" colspan="7"><strong>Genel Toplam</strong></td>
