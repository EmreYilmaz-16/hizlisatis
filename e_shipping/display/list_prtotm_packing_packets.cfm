...
<cfform name="frm_search" method="post" action="#request.self#?fuseaction=sales.popup_list_PRTOTM_packing_packets">
  ...
  <cf_big_list_search title="#attributes.deliver_paper_no# Nolu Sevk Paketleri" collapsed="1">
        <cf_big_list_search_area>
            <table>
                <tr>
                    ...
                    <td><a href="<cfoutput>#request.self#?fuseaction=sales.popup_add_PRTOTM_list_packing</cfoutput>"><img src="/images/back.gif" border="0" title="Geri"></a></td>
                    <td><a href="<cfoutput>#request.self#?fuseaction=sales.popup_add_PRTOTM_packing_fis&ship_id=#attributes.ship_id#&deliver_paper_no=#attributes.deliver_paper_no#&type=#attributes.type#</cfoutput>"><img src="/images/plus_list.gif" border="0" title="Paket Ekle"></a></td>
		  	...
		  	<cfif get_pack_fis.recordcount>
				<cfoutput query="get_pack_fis">
                  <tr height="20" onMouseOver="this.className='color-light';" onMouseOut="this.className='color-row';" class="color-row">
                    ...
                    <td align="right"></td>
                    <td align="center">
                    	<a  href="javascript://" onClick="windowopen('#request.self#?fuseaction=objects.popup_print_files&print_type=32&action_id=#PACKING_ID#','page');">
