        ...
        <cf_big_list_search_area>
            <table>
                <tr>
                    ...
                    <td>
                    <a href="<cfoutput>#request.self#</cfoutput>?fuseaction=sales.popup_add_PRTOTM_list_packing"><img src="/images/plus_list.gif" title="<cf_get_lang_main no='170.Ekle'>"></a></td>
                    <td width="20">
    ...
    <cf_big_list id="list_product_big_list">
        <thead>
            <tr>
                ...
                <th style="text-align:center; width:70px">Sipariş Tarihi</th>
                <th style="text-align:center; width:70px">Sipariş No</th>
