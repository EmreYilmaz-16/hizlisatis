...
SELECT
	...
	ESRR.SHIP_RESULT_ID = ESR.SHIP_RESULT_ID) AS INVOICE_DURUM,
	 ...
	 WHEN ROUND(ISNULL(SUM(PAKETSAYISI), 0),0) < ROUND(ISNULL(SUM(CONTROL_AMOUNT), 0),0) THEN '6-FAZLA SEVKIYAT' ELSE '7-A' END) AS AMBAR_DURUM
