    ...
    <cf_big_list_search_detail_area>
        <cf_object_main_table>
            <cf_object_table column_width_list="50,125">
                <cfsavecontent variable="header_">Satis Yapan</cfsavecontent>
                <cf_object_tr id="form_ul_order_employee" title="#header_#">
                    <cf_object_td type="text" td_style="text-align:right;">Satis Yapan</cf_object_td>
                    <cf_object_td>
                        ...
                        <input name="order_employee" type="text" id="order_employee" style="width:90px;" onfocus="AutoComplete_Create('order_employee','MEMBER_NAME','MEMBER_NAME','get_member_autocomplete','3','EMPLOYEE_ID','order_employee_id','','3','125');" value="<cfif isdefined('attributes.order_employee_id') and len(attributes.order_employee_id) and isdefined('attributes.order_employee') and len(attributes.order_employee)><cfoutput>#attributes.order_employee#</cfoutput></cfif>" autocomplete="off">	
                        <a href="javascript://" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_positions&field_emp_id=order_form.order_employee_id&field_name=order_form.order_employee&is_form_submitted=1&select_list=1','list');"><img src="/images/plus_thin.gif"></a>		   
                    </cf_object_td>
                </cf_object_tr>
            </cf_object_table>
            <cf_object_table column_width_list="50,125">
            ...
            <cf_object_table column_width_list="50,125">
                ...
                <cf_object_tr id="form_ul_product_name" title="#header_#">
                    ...
                    <cf_object_td>
                        ...
                        <a href="javascript://" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_product_names&product_id=order_form.product_id&field_name=order_form.product_name&keyword='+encodeURIComponent(document.order_form.product_name.value),'list');"><img src="/images/plus_thin.gif"></a>
                    </cf_object_td>
                </cf_object_tr>
            </cf_object_table>
	...
	<table class="big_list">
		<thead>
			<tr height="15">
                ...
                <th colspan="3" style="width:100px;text-align:center">Süreç Kontrol</th>
                        ...
                        <tr>
                                ...
                                <cfquery name="get_sevk_durum" datasource="#dsn3#"> <!---Rezerve edilen üretim planları veya satınalma siparişlerinin depoya girişleri kontrol ediliyor--->
                                    ...
                                    FROM         
                                        ...
                                        FROM          
                                            ...
                                            SELECT     
                                                CASE 
                                                    WHEN ORDER_ROW_CURRENCY = - 6 THEN 1 
                            ...
                            <td style="text-align:center">
                                <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=sales.popup_upd_PRTOTM_shipping_sevk&iid=#SHIP_RESULT_ID#&is_type=#is_type#','page');" class="tableyazi" title="Sevk Emri Ver">
                                    ...
                                    <cfelseif get_sevk_durum.sevk_durum eq 1>
                                        <img src="../../../images/red_glob.gif" border="0" title="Tamamı Sevk" />
                                    <cfelseif get_sevk_durum.sevk_durum eq 3>
                            ...
                            <td style="text-align:center">
                                <cfif IS_TYPE eq 1>
                                    ...
                                    <cfelseif DURUM eq 2>
                                        <img src="../../../images/red_glob.gif" border="0" title="Tamamı Kapandı" />
                                    <cfelseif DURUM eq 3>
                                        <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=stock.form_add_sale&order_id=#order_id_list#&order_row_id=#order_row_id_list#','longpage');" class="tableyazi" title="Satış İrsaliyesi Oluştur">
                            ...
                            <td title="#NOTE#"><cfif len(NOTE) gt 70>#left(NOTE,70)#...</cfif></td>
                         	
                            <td style="text-align:center;<cfif DURUM neq 1>background-color:red</cfif>"><a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_print_files&print_type=32&action_id=#is_type#-#SHIP_RESULT_ID#','page');"><img src="/images/print2.gif" alt="<cf_get_lang_main no='62.Yazdır'>" border="0" title="<cf_get_lang_main no='62.Yazdır'>"></a>
                            </td>
                            <td style="text-align:center">
                            	<cfif DURUM eq 1>
                            		<input type="checkbox" name="select_production" value="#IS_TYPE#-#SHIP_RESULT_ID#">
                                </cfif>
                                <cfif IS_TYPE eq 1>
									<cfif PACKEGE_CONTROL.CONTROL_AMOUNT eq 0 and DURUM eq 1>
                	...
                	<cfif isdefined('tip')>
                  	...
                  	<cfelse>
						<cfif attributes.totalrecords gt son_row>
                            <cfoutput>
                                <td style="text-align:left;" colspan="9">Sayfa Toplam</td>
                        ...
                        <cfelse>
                            <cfoutput>
                                <td style="text-align:left;" colspan="9">Genel Toplam</td>
                                <td style="text-align:right;" >#Tlformat(t_point,2)#</td>
                                <td style="text-align:right;" colspan="4">
                                    <input type="button" value="Birleştir" onClick="grupla(-3);">
                                    <input type="button" value="Toplu Yazdır" onClick="grupla(-2);">
