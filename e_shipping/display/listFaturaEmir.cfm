...
,SM.SHIP_METHOD
,SC.CITY_NAME
,(SELECT CONVERT(DECIMAL(18,2),BAKIYE3) BAKIYE3,OTHER_MONEY FROM workcube_metosan_2023_1.COMPANY_REMAINDER_MONEY  CRM WHERE  CRM.COMPANY_ID=PS.COMPANY_ID FOR JSON PATH) AS BAKBIL
FROM workcube_metosan_1.FATURA_EMIR_PBS FP
	...
	LEFT JOIN (
		SELECT *,3 AS PERIOD_ID FROM workcube_metosan_2023_1.INVOICE
		UNION ALL
		SELECT *,2 AS PERIOD_ID FROM workcube_metosan_2022_1.INVOICE
            ...
            <tr>
                ...
                <td>
                    ...
                    <cfloop array="#JsonData#" item="it">
                        #tlformat(it.BAKIYE3)# #OTHER_MONEY#
                    </cfloop>
                </td>
                <td>
                    #CITY_NAME#
