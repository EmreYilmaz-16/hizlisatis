...
<table class="dph">
	<tr> 
		<td class="dpht">Paket Kontrol Listesi 2</td>
	...
	<tr>
		<td>
        	<cf_medium_list>
                ...
                <tfoot>
                    <tr class="color-list">
                        <td colspan="6" align="right"><input type="button" value="Kapat" onClick="kontrol();"> 
                           <input type="button" value="Mail Gönder" onClick="mail_gonder();"></td>
                    </tr>
             	</tfoot>
         	</cf_medium_list>
      	</td>
...
<script language="javascript">
	...
	{
		window.location ='<cfoutput>#request.self#?fuseaction=sales.emptypopup_display_PRTOTM_shipping_mailing&is_type=#attributes.is_type#&ship_id=#attributes.ship_id#</cfoutput>';
	}
</script>