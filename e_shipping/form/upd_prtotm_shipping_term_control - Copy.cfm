					...
					<cfoutput query="GET_SHIP_PACKAGE_LIST">
                        <tr height="20">
                                ...
                                <td style="text-align:right"><strong>#Tlformat(PAKETSAYISI,2)#</strong></td>
                                 <input type="hidden" name="kalan_amount" id="kalan_amount_#currentrow#" value="#Tlformat(PAKETSAYISI,2)#"/>
                                <td style="text-align:right">
                                    ...
                                    <cfelse>
                                        <strong>#Tlformat(CONTROL_AMOUNT,2)#</strong>
                                    </cfif>
                                </td>
	...
	function kontrol(type)
	{
		...
		if(type==1)
		{
			...
			if(convert_list)//Ürün Seçili ise
			{
				 ...
				 if(type==1)
				 {
					 aktar_form.action="<cfoutput>#request.self#?fuseaction=sales.add_PRTOTM_shipping_control_fis&is_type=#attributes.is_type#&kontrol_status=2</cfoutput>";
