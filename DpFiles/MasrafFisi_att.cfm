...
<cfscript>
	...
	WRK_ROUND  = caller.WRK_ROUND;
	LISTDELETEDUPLICATES = caller.LISTDELETEDUPLICATES;
	SQL_UNICODE = caller.SQL_UNICODE;
	WORKCUBE_MODE = caller.WORKCUBE_MODE;
	TLFORMAT = caller.TLFORMAT;
	cfquery = caller.cfquery;
    muhasebeci=caller.muhasebeci;
    carici=caller.carici;
</cfscript>
