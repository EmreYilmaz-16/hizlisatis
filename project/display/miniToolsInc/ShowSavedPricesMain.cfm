<cfquery name="getMains" datasource="#dsn3#">
    ...
    SELECT SUM((((AMOUNT*PRICE)-((AMOUNT*PRICE)*DISCOUNT)/100))*RATE2) AS TUTAR FROM <cfif attributes.is_virtual eq 0>
    workcube_metosan_1.PROJECT_REAL_PRODUCTS_TREE_PRICES
<cfelse>
    workcube_metosan_1.PROJECT_VIRTUAL_PRODUCTS_TREE_PRICES
</cfif>
