<cf_box title="Fiyat Göster" scroll="1" collapsable="1" resize="1" popup_box="1">
        ...
        <table>
            <tr>
                ...
                <td>
                    <input class="form-control" type="text" id="fdy_0001" onchange="SatirFiyatHesapla(this)" value="<cfoutput>#FData.Discount#</cfoutput>">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input class="form-control" type="text" id="fy_0003" onkeyup="fiyatHesaplaPoppi()"  value="<cfoutput>#FData.Price#</cfoutput>">
                </td>
            </tr>
            <tr>
                <td>
