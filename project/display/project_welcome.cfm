...
<cf_box title="Üretim Projeler">
    <div class="list-group">
        ...
        <a class="list-group-item list-group-item-action"
           onclick="window.location.href='index.cfm?fuseaction=project.emptypopup_list_projects_pbs'">
            <img src="/images/e-pd/pr.png">
            Projeler</a>
        <a class="list-group-item list-group-item-action"
           onclick="window.location.href='index.cfm?fuseaction=project.emptypopup_list_projects_pbs&list_my_projects=1'">
            <img src="/images/e-pd/mpr.png">
            Görevlisi Olduğum Projeler</a>
        <a class="list-group-item list-group-item-action"
           onclick="openBoxDraggable('index.cfm?fuseaction=project.emptypopup_add_project_fast')">
        ...
        <a class="list-group-item list-group-item-action"
           onclick="window.location.href='index.cfm?fuseaction=project.emptypopup_list_myworks'">
        ...
        <a class="list-group-item list-group-item-action"
           onclick="window.location.href='index.cfm?fuseaction=project.emptypopup_list_project_notes&act=list_my'">
            ...
            Notlarım</a>
            <a class="list-group-item list-group-item-action"
            onclick="window.location.href='index.cfm?fuseaction=project.emptypopup_project_tanim'">
