        ...
        <cfoutput query="getProjectNeeds">
            <tr style="<cfif IS_VIRTUAL eq 1>background:##ff00006b<cfelse></cfif>">
                ...
                <cfquery name="ihes" datasource="#dsn3#">
                    SELECT * FROM (
SELECT IR.STOCK_ID,IR.QUANTITY,CASE WHEN INTERNALDEMAND_STAGE =353 THEN 0 ELSE 1 END AS ISLEM,I.INTERNAL_NUMBER AS PP_NUMBER FROM workcube_metosan_1.INTERNALDEMAND_ROW AS IR
