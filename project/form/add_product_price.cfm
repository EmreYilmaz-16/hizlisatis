...
<tfoot>
    ...
    <cfquery name="SEVIYE_2" datasource="#DSN3#">
        ...
        <CFELSE>
            SELECT PRODUCT_TREE_ID AS PTID, S.PRODUCT_ID,S.STOCK_ID SIDO ,ISNULL(AMOUNT,0) AMOUNT,ISNULL(ISNULL(PEPS.PRICE,PRICE_PBS),0) AS PRICE,ISNULL(ISNULL(PEPS.DISCOUNT,DISCOUNT_PBS),0) AS DISCOUNT ,ISNULL(ISNULL(PEPS.OTHER_MONEY,OTHER_MONEY_PBS),'TL') AS MONEY ,S.PRODUCT_NAME,0 AS IS_VIRTUAL,PRODUCT_UNIT_ID FROM workcube_metosan_1.PRODUCT_TREE AS PT 
