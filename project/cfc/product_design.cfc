...
<cfif arguments.IS_VIRTUAL neq 1 and len(arguments.PRODUCT_ID)>
            ...
            <cfreturn ReturnData>
        <cfelse>
            <cfquery name="getvpprc" datasource="#arguments.ddsn3#" >
