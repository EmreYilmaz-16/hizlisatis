<cfcomponent>   
    ...
    <cffunction name="getPriceFunk">
        ...
        <cfargument name="PRICE_CATID">
        <cfargument name="ddsn3">
<cfif arguments.IS_VIRTUAL eq 0>
