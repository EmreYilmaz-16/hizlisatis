<cfcomponent>   
    ...
    <cffunction name="getTrees">
        ...
        <cfquery name="getTree" datasource="#dsn3#"><cfif arguments.isVirtual eq 1>SELECT *,VPT_ID AS PRODUCT_TREE_ID FROM VIRTUAL_PRODUCT_TREE_PRT WHERE VP_ID=#arguments.pid#<cfelse>select *,0 AS IS_VIRTUAL from PRODUCT_TREE WHERE STOCK_ID=#arguments.pid# </cfif></cfquery>       
      <cfset say=0> 
