            ...
            <li class="nav-item dropdown">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <cfelse>
                        <li><a class="dropdown-item" onclick="window.location.href='index.cfm?fuseaction=product.emptypopup_design_product_pbs&project_id=<cfoutput>#attributes.project_id#</cfoutput>'" style="font-size:9pt;display:flex" ><img src="/images/e-pd/pr.pdesign" style="width:20px;margin-right:10px">Ürün Dizayn</a></li>                                    
