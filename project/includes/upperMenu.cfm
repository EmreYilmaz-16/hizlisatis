...
<nav class="navbar navbar-expand-lg bg-body-tertiary" style="padding:0">
    <div class="container-fluid">
      <a class="navbar-brand" href="#"><img src="/images/e-pd/Home.png"></a>
            ...
            <li class="nav-item dropdown">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <cfelse>
                      <li><a class="dropdown-item" onclick="window.location.href='index.cfm?fuseaction=project.emptypopup_detail_project_pbs&project_id=<cfoutput>#attributes.project_id#</cfoutput>'" style="font-size:9pt;display:flex" ><img src="/images/e-pd/home.png" style="width:20px;margin-right:10px">Ürün Dizayn</a></li>  
