        ...
        <cfloop array="#AGACIM#" item="Ait"> <!--- //BILGI Ağaç Döngüsü ---->            
            <cfif Ait.is_virtual eq 1> <!--- //BILGI Ürün Sanalmı ---->
                ...
                <cfif Ait.PRODUCT_ID neq 0 and len(Ait.PRODUCT_ID) gt 0> <!--- //BILGI ürün Eklenmiş mi ? ---->
                   ...
                   <cfscript>
                    ...
                    <cfoutput>
                        <span style="color:red">POS: 00001 001</span><br/>
                    ...
                    <cfif isDefined("ait.AGAC")>
                    <cfelse>
                        <cfset ait.AGAC=arrayNew(1)>
                    </cfif>
            ...
            <cfelse>
                <cfif isDefined("ait.QUESTION_ID") AND LEN(ait.QUESTION_ID)><cfset aiq=Ait.QUESTION_ID><cfelse><cfset aiq="NULL"></cfif>
                    ...
                    <cfif isDefined("ait.DISCOUNT")><cfset aid=Ait.DISCOUNT><cfelse><cfset aid="0"></cfif>
                    <cfif isDefined("ait.MONEY")><cfset aim=Ait.MONEY><cfelse><cfset aim="TL"></cfif>
                    <cfif isDefined("ait.DISPLAY_NAME") and Ait.DISPLAY_NAME neq "undefined"><cfset dName=Ait.DISPLAY_NAME><cfelse><cfset dName=""></cfif>
                <cfscript>
                    if(isDefined("Ait.price")){
                        prcex=Ait.price;
                    }else{
