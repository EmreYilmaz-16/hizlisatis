...
LEFT JOIN #DSN3#.ORDERS_INVOICE AS OI ON OI.ORDER_ID=O.ORDER_ID AND OI.PERIOD_ID=2
LEFT JOIN workcube_metosan_2022_1.INVOICE AS I ON I.INVOICE_ID=OI.INVOICE_ID
LEFT JOIN #DSN3#.ORDERS_SHIP AS OS ON OS.ORDER_ID=O.ORDER_ID AND OI.PERIOD_ID=2
