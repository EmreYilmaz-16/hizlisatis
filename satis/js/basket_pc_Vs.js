...
function AddRow(
  ...
  var td = document.createElement("td");
  var i_1 = createHiddenInput("product_id_" + row_count, product_id);
  var i_2 = createHiddenInput("stock_id_" + row_count, stock_id);
  var i_3 = createHiddenInput("is_virtual_" + row_count, is_virtual);
  var i_4 = createHiddenInput("shelf_code_" + row_count, RafKodu);
  var i_5 = createHiddenInput("cost_" + row_count, cost);
  var i_55 = createHiddenInput("is_karma_" + row_count, is_karma);
  var i_6 = createHiddenInput("is_production_" + row_count, is_production);
  var i7 = createHiddenInput("row_uniq_id_" + row_count, row_uniq_id.length > 0 ? row_uniq_id : GenerateUniqueId());
  var i8 = createHiddenInput("is_manuel_" + row_count, is_manuel);
  ...
  var i_4 = createTextInput("stock_code_" + row_count, stock_code, "width:40px", "stockkodu", true);
  ...
  var i_4 = createTextInput("product_name_" + row_count, product_name, "width:40px", "urunadi");
  var div = document.createElement("div");
  div.setAttribute("class", "form-group");
  div.appendChild(i_4);
  td.appendChild(div);
  ...
  var i_4 = createTextInput("brand_name_" + row_count, brand_name, "", "", true);
  var div = document.createElement("div");
  div.setAttribute("class", "form-group");
  div.appendChild(i_4);
  td.appendChild(div);
  ...
  var td = document.createElement("td");
  td.setAttribute("style", "width:5%");
  var i_4 = createTextInput("department_name" + row_count, rff, "", "", true);
  var div = document.createElement("div");
  div.setAttribute("class", "form-group");
  div.appendChild(i_4);
  td.appendChild(div);
  ...
  var i_5 = createTextInput("amount_" + row_count, commaSplit(quantity, 2), "", "prtMoneyBox", false, "hesapla('price'," + row_count + ")", "sellinputAllVal(this)");
  var div = document.createElement("div");
  div.setAttribute("class", "form-group");
  div.appendChild(i_5);
  td.appendChild(div);
  ...
  var td = document.createElement("td");
  td.setAttribute("style", "width:3%");
  var i_5 = createTextInput("main_unit_" + row_count, product_unit, "width:20px", "", true);
  var div = document.createElement("div");
  div.setAttribute("class", "form-group");
  div.appendChild(i_5);
  td.appendChild(div);
  ...
  var td = document.createElement("td");
  td.setAttribute("style", "width:3%");
  var sel = createSelect("other_money_" + row_count, moneyArr, other_money, "hesapla('other_money'," + row_count + ")");
  var div = document.createElement("div");
  div.setAttribute("class", "form-group");
  div.appendChild(sel);
  td.appendChild(div);
  ...
  var td = document.createElement("td");
  td.setAttribute("style", "width:5%");
  var i_10 = createTextInput("price_other_" + row_count, commaSplit(price_other, FiyatYuvarlama), "width:30px", "prtMoneyBox", false, "hesapla('price_other'," + row_count + ")");
  var div = document.createElement("div");
  div.setAttribute("class", "form-group");
  ...
  var td = document.createElement("td");
  td.setAttribute("style", "width:5%");
  var i_6 = createTextInput("price_" + row_count, commaSplit(prc, FiyatYuvarlama), "width:30px", "prtMoneyBox", false, "hesapla('price'," + row_count + ")", "sellinputAllVal(this)");
  var div = document.createElement("div");
  div.setAttribute("class", "form-group");
  div.appendChild(i_6);
  td.appendChild(div);
  ...
  var td = document.createElement("td");
  td.setAttribute("style", "width:5%");
  var i_9 = createTextInput("indirim1_" + row_count, commaSplit(discount_rate), "", "prtMoneyBox", false, "getSetNum(this)&hesapla('price'," + row_count + ")");
  var div = document.createElement("div");
  div.setAttribute("class", "form-group");
  div.appendChild(i_9);
  td.appendChild(div);
  ...
  var i_7 = createTextInput("row_nettotal_" + row_count, commaSplit(0, Yuvarlama), "", "prtMoneyBox", true);
  var div = document.createElement("div");
  div.setAttribute("class", "form-group");
  div.appendChild(i_7);
  td.appendChild(div);
  ...
  var td = document.createElement("td");
  td.setAttribute("style", "width:15%");
  var i_4 = createTextInput("product_name_other_" + row_count, product_name_other, "width:40px");
  var div = document.createElement("div");
  div.setAttribute("class", "form-group");
  div.appendChild(i_4);
  td.appendChild(div);
  ...
  var i_4 = createTextInput("detail_info_extra_" + row_count, detail_info_extra, "width:40px");
  var div = document.createElement("div");
  div.setAttribute("class", "form-group");
  div.appendChild(i_4);
  td.appendChild(div);
  ...
  var td = document.createElement("td");
  td.setAttribute("style", "width:10%");
  var i_4 = createTextInput("deliver_date_" + row_count, deliver_date.length > 0 ? deliver_date : dtd.toISOString().split("T")[0], "", "", false, "", "", "date");
  var div = document.createElement("div");
  div.setAttribute("class", "form-group");
  div.appendChild(i_4);
  td.appendChild(div);
  ...
  var i_8 = createHiddenInput("Tax_" + row_count, commaSplit(tax));
  var i88 = createHiddenInput("converted_sid_" + row_count, converted_sid);
  var div = document.createElement("div");
  div.setAttribute("class", "form-group");
  div.appendChild(i_8);
  div.appendChild(i88);
  ...
  var div = document.createElement("div");
  div.setAttribute("class", "form-group");
  var input_11 = createTextInput("description_" + row_count, description);
...
function createTextInput(name, value, style = "", className = "", readOnly = false, onChange = "", onClick = "", type = "text") {
  var input = document.createElement("input");
  input.setAttribute("name", name);
  input.setAttribute("id", name);
...
function createSelect(name, options, selectedValue, onChange) {
  ...
  options.forEach(function (option) {
    ...
    opt.setAttribute("value", option.MONEY);
    opt.innerText = option.MONEY;
...
function AsamaYapici(rc, selv) {
  ...
  var options = [
    { value: -5, text: "Üretim" },
    { value: -6, text: "Sevk" },
    { value: -2, text: "Tedarik" },
    { value: -1, text: "Açık" },
    { value: -10, text: "Kapatıldı" },
    { value: 1, text: "Fiyat Talep" },
  ];
  options.forEach(function (option) {
    var opt = document.createElement("option");
