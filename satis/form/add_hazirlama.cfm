            ...
            <cfloop query="getKp">
                <tr>
                    ...
                    <td><div class="form-group" style="display:flex">
                        ...
                        <input type="text" name="quantity22_#getS.currentrow#_#currentrow#" value="#tlformat(AMOUNT,2)#" style="padding-right: 0;text-align: right;width:25%;margin-left:2px !important" disabled readonly>
                    </div>
                        </td>
                    <td>
