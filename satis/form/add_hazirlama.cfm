...
SELECT  ISNULL(AMOUNT,0) AMOUNT,DELIVER_DEPT,DELIVER_LOCATION,PRODUCT_NAME,PRODUCT_PLACE_ID,QUANTITY,SHELF_CODE,SHIP_RESULT_ROW_ID,STOCK_ID,DETAIL_INFO_EXTRA,BRAND_NAME,PRODUCT_CODE,DESCRIPTION,UNIQUE_RELATION_ID FROM (
SELECT ORR.QUANTITY,ORR.UNIQUE_RELATION_ID,SF.AMOUNT,S.PRODUCT_NAME,S.PRODUCT_CODE,PP.SHELF_CODE,ORR.DELIVER_DEPT,ORR.DELIVER_LOCATION,S.STOCK_ID,SRR.SHIP_RESULT_ROW_ID,PP.PRODUCT_PLACE_ID,ORR.DETAIL_INFO_EXTRA,B.BRAND_NAME,ORR.DESCRIPTION FROM #dsn3#.PRTOTM_SHIP_RESULT_ROW AS SRR
