...
<cffunction name="SaveRealHydrolic" access="remote" returntype="any" returnFormat="json">
    ...
    <CFOUTPUT query="getMaster">
        <cfscript>
            ...
            satis_fiyat_kdvli = filternum(arguments.hydSubTotal)+((filternum(arguments.hydSubTotal)*18)/100);
    ...
    <CFSET RETURN_VAL.PRICE_OTHER=Filternum(arguments.hydSubTotal)>
    <CFSET RETURN_VAL.OFFER_ROW_CURRENCY=-5>
    <CFSET RETURN_VAL.IS_MANUEL=0>
    <CFSET RETURN_VAL.COST=Filternum(arguments.hydSubTotal)>
