...
WHERE FROM_PROJE=1
AND DEPARTMENT_OUT=#arguments.DEPARTMENT_ID# AND LOCATION_OUT=#arguments.LOCATION_ID# AND OCC=1 AND INTERNALDEMAND.PREPARE_PERSONAL IS NULL AND  INTERNALDEMAND.INTERNALDEMAND_STAGE=352
<CFSET returnArr=arrayNew(1)>
