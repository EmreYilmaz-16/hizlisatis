...
SELECT DISTINCT ISNULL(S.AMOUNT,0) AS AMOUNT,I.INTERNAL_NUMBER,I.DEPARTMENT_OUT,I.LOCATION_OUT,I.PROJECT_ID,workcube_metosan.getEmployeeWithId(EP.EMPLOYEE_ID) AS KAYDEDEN,I.INTERNAL_ID FROM #datasources.dsn3#.INTERNALDEMAND AS I
