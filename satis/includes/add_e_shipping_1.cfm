<cfset ATTRIBUTES.XML_MULTIPLE_COUNTING_FIS =1>
    ...
    <cftransaction>
        ...
        <cfquery name="get_GEN_PAP" datasource="#DSN3#">
            ...
            SHIP_FIS_NO_PDA,
            SHIP_FIS_NUMBER_PDA,
            SHIP_FIS_NO_PDA + '-' + CAST(SHIP_FIS_NUMBER_PDA+1 AS CHAR(6)) AS FISNO
            FROM            
                GENERAL_PAPERS
            WHERE        
                GENERAL_PAPERS_ID = 1
        </cfquery>
        <CFSET NEW_NUMBER = (get_GEN_PAP.SHIP_FIS_NUMBER_PDA*1) + 1>
        ...
        <cfquery name="UPD_GEN_PAP" datasource="#DSN3#">
            UPDATE GENERAL_PAPERS SET SHIP_FIS_NUMBER_PDA = #NEW_NUMBER# WHERE SHIP_FIS_NUMBER_PDA IS NOT NULL
        </cfquery>
