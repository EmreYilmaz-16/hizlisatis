...
<cfquery name="getMaster" datasource="#datam.dataSources.dsn3#">
   SELECT S.*,PIP.PROPERTY1,PU.MAIN_UNIT,PB.BRAND_NAME  FROM #DSN3#.STOCKS AS S
   ...
   LEFT JOIN #DSN3#.PRODUCT_BRANDS AS PB ON S.BRAND_ID=PB.BRAND_ID
...
<cfquery name="getShelf" datasource="#datam.dataSources.dsn3#">
    SELECT SHELF_CODE FROM #DSN3#.PRODUCT_PLACE_ROWS AS PPR
