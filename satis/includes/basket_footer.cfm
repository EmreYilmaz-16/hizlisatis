...
<table style="width:100%" >
    <tr>
        ...
        <table style="width:100%" cellspacing="0" border="0" class="CurrencyTable">
            <tr>
                    <td>
                        Toplam
                    </td>
...
<tr>
    ...
    <tr>
        <td>
            <table style="width:100%" cellspacing="0" border="0" class="CurrencyTable" id="qs_basket">
                <thead>
                    <tr>
                ...
                <cfif isDefined("GETOFFERmONEY")>
                    <cfoutput query="GETOFFERmONEY">
                        <tr>   
                            ...
                            <td nowrap="nowrap"><input type="radio" class="rdMoney" id="_rd_money" name="_rd_money" value="#CurrentRow#" <cfif MONEY_TYPE eq session.ep.money>checked="checked"</cfif>></td>
