...
<cf_box title="İlişkili Fatura ve İrsaliyeler">
   ...
   SELECT * FROM (SELECT 
ISNULL(ISNULL(ISNULL(I.INVOICE_NUMBER,I1.INVOICE_NUMBER),I2.INVOICE_NUMBER),I3.INVOICE_NUMBER) AS ACTION_NUMBER
,ISNULL(ISNULL(ISNULL(I.INVOICE_ID,I1.INVOICE_ID),I2.INVOICE_ID),I3.INVOICE_ID) AS ACTION_ID
,ISNULL(ISNULL(ISNULL(I.INVOICE_DATE,I1.INVOICE_DATE),I2.INVOICE_DATE),I3.INVOICE_DATE) AS ACTION_DATE
,OI.PERIOD_ID
,'FATURA' AS TIP,OI.ORDER_ID FROM #DSN3#.ORDERS_INVOICE AS OI 
LEFT JOIN (SELECT *,5 AS PERIOD_ID FROM  workcube_metosan_2025_1.INVOICE  ) I3 ON OI.INVOICE_ID=I3.INVOICE_ID AND OI.PERIOD_ID=I3.PERIOD_ID
LEFT JOIN (SELECT *,4 AS PERIOD_ID FROM  workcube_metosan_2024_1.INVOICE  ) I ON OI.INVOICE_ID=I.INVOICE_ID AND OI.PERIOD_ID=I.PERIOD_ID
LEFT JOIN (SELECT *,3 AS PERIOD_ID FROM  workcube_metosan_2023_1.INVOICE  ) I1 ON OI.INVOICE_ID=I1.INVOICE_ID AND OI.PERIOD_ID=I1.PERIOD_ID
LEFT JOIN (SELECT *,2 AS PERIOD_ID FROM  workcube_metosan_2022_1.INVOICE  ) I2 ON OI.INVOICE_ID=I2.INVOICE_ID AND OI.PERIOD_ID=I2.PERIOD_ID
UNION 
SELECT 
ISNULL(ISNULL(ISNULL(I.SHIP_NUMBER,I1.SHIP_NUMBER),I2.SHIP_NUMBER),I3.SHIP_NUMBER) AS ACTION_NUMBER
,ISNULL(ISNULL(ISNULL(I.SHIP_ID,I1.SHIP_ID),I2.SHIP_ID),I3.SHIP_ID) AS ACTION_ID
,ISNULL(ISNULL(ISNULL(I.SHIP_DATE,I1.SHIP_DATE),I2.SHIP_DATE),I3.SHIP_ID) AS ACTION_DATE
,OI.PERIOD_ID

,'IRSALIYE' AS TIP,OI.ORDER_ID FROM #DSN3#.ORDERS_SHIP AS OI 
LEFT JOIN (SELECT *,5 AS PERIOD_ID FROM  workcube_metosan_2025_1.SHIP  ) I3 ON OI.SHIP_ID=I3.SHIP_ID AND OI.PERIOD_ID=I3.PERIOD_ID
LEFT JOIN (SELECT *,4 AS PERIOD_ID FROM  workcube_metosan_2024_1.SHIP  ) I ON OI.SHIP_ID=I.SHIP_ID AND OI.PERIOD_ID=I.PERIOD_ID
LEFT JOIN (SELECT *,3 AS PERIOD_ID FROM  workcube_metosan_2023_1.SHIP  ) I1 ON OI.SHIP_ID=I1.SHIP_ID AND OI.PERIOD_ID=I1.PERIOD_ID
LEFT JOIN (SELECT *,2 AS PERIOD_ID FROM  workcube_metosan_2022_1.SHIP  ) I2 ON OI.SHIP_ID=I2.SHIP_ID AND OI.PERIOD_ID=I2.PERIOD_ID
) AS OI
