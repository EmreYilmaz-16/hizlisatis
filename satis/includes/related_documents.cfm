...
LEFT JOIN ( 
			SELECT SHIP_NUMBER  COLLATE SQL_Latin1_General_CP1_CI_AS AS INVOICE_NUMBER,SHIP_ID AS ACTION_ID, 2 AS PERIOD_ID FROM #dsn#_#session.ep.PERIOD_YEAR#_#session.ep.COMPANY_ID#.SHIP 
			<cfloop query="getPeriods">
            UNION 
			SELECT SHIP_NUMBER COLLATE SQL_Latin1_General_CP1_CI_AS AS INVOICE_NUMBER,SHIP_ID AS ACTION_ID ,1 AS PERIOD_ID FROM #dsn#_#PERIOD_YEAR#_#OUR_COMPANY_ID#.SHIP 
            </cfloop>
...
LEFT JOIN ( 
			SELECT INVOICE_NUMBER COLLATE SQL_Latin1_General_CP1_CI_AS AS INVOICE_NUMBER,INVOICE_ID AS ACTION_ID, 2 AS PERIOD_ID FROM #dsn#_#session.ep.PERIOD_YEAR#_#session.ep.COMPANY_ID#.INVOICE 
			<cfloop query="getPeriods">
            UNION 
			SELECT INVOICE_NUMBER COLLATE SQL_Latin1_General_CP1_CI_AS AS INVOICE_NUMBER,INVOICE_ID AS ACTION_ID,1 AS PERIOD_ID FROM #dsn#_#session.ep.PERIOD_YEAR#_#session.ep.COMPANY_ID#.INVOICE 
            </cfloop>
