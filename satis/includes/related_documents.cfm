...
LEFT JOIN (SELECT *,5 AS PERIOD_ID FROM  workcube_metosan_2025_1.INVOICE  ) I ON OI.INVOICE_ID=I.INVOICE_ID AND OI.PERIOD_ID=I.PERIOD_ID
...
LEFT JOIN (SELECT *,5 AS PERIOD_ID FROM  workcube_metosan_2025_1.SHIP  ) I ON OI.SHIP_ID=I.SHIP_ID AND OI.PERIOD_ID=I.PERIOD_ID
