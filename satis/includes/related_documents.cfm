...
LEFT JOIN (SELECT *,3 AS PERIOD_ID FROM  workcube_metosan_2024_1.INVOICE  ) I ON OI.INVOICE_ID=I.INVOICE_ID AND OI.PERIOD_ID=I.PERIOD_ID
LEFT JOIN (SELECT *,2 AS PERIOD_ID FROM  workcube_metosan_2023_1.INVOICE  ) I1 ON OI.INVOICE_ID=I1.INVOICE_ID AND OI.PERIOD_ID=I1.PERIOD_ID
LEFT JOIN (SELECT *,1 AS PERIOD_ID FROM  workcube_metosan_2022_1.INVOICE  ) I2 ON OI.INVOICE_ID=I2.INVOICE_ID AND OI.PERIOD_ID=I2.PERIOD_ID
UNION 
SELECT 
...
LEFT JOIN (SELECT *,3 AS PERIOD_ID FROM  workcube_metosan_2024_1.SHIP  ) I ON OI.SHIP_ID=I.SHIP_ID AND OI.PERIOD_ID=I.PERIOD_ID
LEFT JOIN (SELECT *,2 AS PERIOD_ID FROM  workcube_metosan_2023_1.SHIP  ) I1 ON OI.SHIP_ID=I1.SHIP_ID AND OI.PERIOD_ID=I1.PERIOD_ID
LEFT JOIN (SELECT *,1 AS PERIOD_ID FROM  workcube_metosan_2022_1.SHIP  ) I2 ON OI.SHIP_ID=I2.SHIP_ID AND OI.PERIOD_ID=I2.PERIOD_ID
) AS OI
