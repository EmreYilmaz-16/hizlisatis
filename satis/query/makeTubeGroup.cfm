...
<cfoutput>window.opener.AddRow(#product_info.PRODUCT_ID#,#product_info.STOCK_ID#,'#product_info.STOCK_CODE#','#product_info.BRAND_NAME#',0,1,#product_info.PRICE#,'#product_info.PRODUCT_NAME#',#product_info.TAX#,#product_info.DISCOUNT_RATE#,1,'',"TL",#product_info.PRICE#,-1,0,0,"Adet","","",0,"","",0,"","","",0,1,0,1,1)</cfoutput>
