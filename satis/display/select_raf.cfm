...
WHERE PPR.STOCK_ID=#attributes.sid_# AND D.BRANCH_ID IN (SELECT D.BRANCH_ID FROM #dsn#.EMPLOYEE_POSITIONS AS EP INNER JOIN #dsn#.DEPARTMENT AS D ON D.DEPARTMENT_ID =EP.DEPARTMENT_ID WHERE EP.POSITION_CODE=EP.POSITION_CODE)
</cfquery>
<cf_grid_list>
	<tr>
		<th>Raf</th>
