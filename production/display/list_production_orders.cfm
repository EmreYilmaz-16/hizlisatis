...
<cf_box title="Üretim Emirleri">
	...
	SELECT * FROM (
SELECT VPO.V_P_ORDER_ID,VPO.V_P_ORDER_NO ,VPO.STOCK_ID,ISNULL(VPO_2.UNIQUE_RELATION_ID,VPO.UNIQUE_RELATION_ID) UNIQUE_RELATION_ID,PO.COMPANY_ID,C.NICKNAME,S.PRODUCT_NAME ,VPOR.REAL_RESULT_ID,
