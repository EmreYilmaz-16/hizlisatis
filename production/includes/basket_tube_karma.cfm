...
<cf_box title="Üretim Emri #getPo2.V_P_ORDER_NO# - #gets.PRODUCT_NAME#" edit_href="/index.cfm?fuseaction=production.emptypopup_update_virtual_production_orders&VP_ORDER_ID=#getPo2.V_P_ORDER_ID#" collapsed="1">
	<cfoutput>
