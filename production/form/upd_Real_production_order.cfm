<div class="row">
    <div class="col col-1">
		...
		<button type="button" onclick="windowopen('/index.cfm?fuseaction=project.emptypopup_mini_tools&tool_type=UE-TR&P_ORDER_ID=<cfoutput>#attributes.P_ORDER_ID#</cfoutput>&print_type=281&action=prod.order')" class="ui-wrk-btn ui-wrk-btn-extra"><i class="icn-md fa fa-exchange"></i> &nbsp; Karşılaştır</button>
    </cf_box>
    </div>
