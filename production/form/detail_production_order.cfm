...
<cfif getPo.IS_FROM_VIRTUAL eq 1>
	...
	<cfquery name="getsTree" datasource="#dsn3#">
	            SELECT S.PRODUCT_NAME,S.STOCK_CODE,S.STOCK_ID,VPT.AMOUNT,VPQ.QUESTION,PU.MAIN_UNIT,VP_ID,VPQ.QUESTION_ID FROM #dsn3#.VIRTUAL_PRODUCT_TREE_PRT AS VPT
...
LEFT JOIN #dsn3#.PRODUCT_UNIT AS PU ON PU.PRODUCT_ID=S.PRODUCT_ID AND PRODUCT_UNIT_STATUS=1
	...
	SELECT * FROM VIRTUAL_PRODUCT_TREE_QUESTIONS WHERE QUESTION_PRODUCT_TYPE=#gets.PRODUCT_TYPE#
	</cfquery>
<cfelse>
