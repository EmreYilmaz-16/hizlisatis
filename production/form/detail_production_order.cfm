...
<cfif getPo.IS_FROM_VIRTUAL eq 1>
	<cfquery name="gets" datasource="#dsn3#">
		        SELECT VIRTUAL_PRODUCT_ID,PRODUCT_NAME,PC.PRODUCT_CATID,PRICE,MARJ,PRODUCT_DESCRIPTION,PRODUCT_TYPE,IS_CONVERT_REAL,#dsn#.getEmployeeWithId(RECORD_EMP) RECORD_EMP,RECORD_DATE,#dsn#.getEmployeeWithId(UPDATE_EMP) UPDATE_EMP,UPDATE_DATE,PC.PRODUCT_CAT FROM workcube_metosan_1.VIRTUAL_PRODUCTS_PRT 
