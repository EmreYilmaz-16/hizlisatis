	...
	<cfinclude template="../../../../objects/query/get_product_prices_sa_ss.cfm">
  	...
  	<cf_medium_list_search title="TEKLİFLER">
		...
		<cf_medium_list>
			...
			<tbody>
				<cfoutput query="get_offer_list" maxrows="10">
				...
				<tr>
					...
					<td>#OFFER_NUMBER#</td>
					<td style="text-align:right;" class="tableyazi">#TLFormat(get_offer_list.price,session.ep.our_company_info.purchase_price_round_num)#&nbsp;#money_value#</td>
					<td style="text-align:right;">
					<cfif len(OTHER_MONEY) and len(PRICE_OTHER)>
						#TLFormat(PRICE_OTHER,session.ep.our_company_info.sales_price_round_num)#&nbsp;#OTHER_MONEY#
					</cfif>
