...
<cfquery name="showq" datasource="#dsn3#">
    SELECT S.BARCOD,S.PRODUCT_NAME,S.PRODUCT_CODE,PT.QUESTION_ID,PT.AMOUNT,SQ.QUESTION_NAME,PU.MAIN_UNIT,PT.UNIT_ID FROM workcube_metosan_1.PRODUCT_TREE AS PT
LEFT JOIN workcube_metosan_1.STOCKS AS S ON S.STOCK_ID=PT.RELATED_ID
