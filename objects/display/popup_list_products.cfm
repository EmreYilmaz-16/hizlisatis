   ...
   <!--- <td>
    ...
    <td><div class="form-group">
        <div class="input-group" style="position: static;">
            ...
            <input type="text" name="miktar" class="form-control" id="miktar" onkeyup="Filtrele(this,event)" onchange="this.value=commaSplit(this.value)" value="<cfoutput>#TLFormat(1)#</cfoutput>" placeholder="Miktar" ></div>
    ...
    <td>
        ...
        <div class="input-group" style="position: static;">
            ...
            <input disabled=""  type="Text" class="form-control" name="brand_name" id="brand_name" placeholder="Marka" onfocus="AutoComplete_Create('brand_name','BRAND_NAME','BRAND_NAME','get_brand','','BRAND_ID','brand_id','','3','100',1,'applyFilters(1)');" autocomplete="off" style=""><div id="brand_name_div_2" name="brand_name_div_2" class="completeListbox" autocomplete="on" style="width: 153px; max-height: 150px; overflow: auto; position: absolute; left: 932.375px; top: 79px; z-index: 159; display: none;"></div>
