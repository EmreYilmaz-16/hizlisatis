<cf_box title="Sanal Ürün Detay">
    <cfquery name="GetVp" datasource="#DSN3#">
        SELECT VIRTUAL_PRODUCT_ID,PRODUCT_NAME,PRODUCT_CATID,PRICE,MARJ,PRODUCT_TYPE,IS_CONVERT_REAL,#dsn#.getEmployeeWithId(RECORD_EMP) RECORD_EMP,RECORD_DATE,#dsn#.getEmployeeWithId(UPDATE_EMP) UPDATE_EMP,UPDATE_DATE FROM workcube_metosan_1.VIRTUAL_PRODUCTS_PRT where VIRTUAL_PRODUCT_ID=#attributes.pid#
    </cfquery>
...
<div class="ui-cards">
    ...
    <div class="ui-cards-text">
        ...
        <cfquery name="getVirtualTree" datasource="#dsn3#">
            ...
            SELECT S.PRODUCT_NAME,S.STOCK_CODE,VPT.AMOUNT,VPQ.QUESTION,PU.MAIN_UNIT,VP_ID FROM workcube_metosan_1.VIRTUAL_PRODUCT_TREE_PRT AS VPT
