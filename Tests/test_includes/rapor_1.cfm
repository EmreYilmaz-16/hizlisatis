...
<cfquery name="GETA" datasource="#DSN2#">
    SELECT * FROM CARI_ROWS WHERE FROM_CMP_ID=#getc.COMPANY_ID# ORDER BY ACTION_DATE
</cfquery>
<CFSET AF=0>
<CFSET SF=0>
...
<cfquery name="GETS" datasource="#DSN2#">
    SELECT * FROM CARI_ROWS WHERE TO_CMP_ID=#getc.COMPANY_ID# ORDER BY ACTION_DATE
</cfquery>
