    ...
    if (ev.keyCode == 13 || ev.type == 'change' || ev.key == '*') {
        ...
        $.ajax({
            ...
            success: function (retDat) {
                ...
                var q = "select DISTINCT SHELF_CODE,PPR.PRODUCT_PLACE_ID,PPR.PRODUCT_ID,PP.STORE_ID,PP.LOCATION_ID,PPR.PRODUCT_ID,SL.DEPARTMENT_LOCATION from workcube_test_1.PRODUCT_PLACE_ROWS AS PPR"
                q += " LEFT JOIN workcube_test_1.PRODUCT_PLACE AS PP ON PP.PRODUCT_PLACE_ID=PPR.PRODUCT_PLACE_ID "
